...
for n in 0.6 0.7 0.8 0.9 1.0 1.1 1.2 1.3 1.4 1.5 2.0 3.0 4.0 5.0 10.0; do
    ...
    output=$(python3 run_structure_factor.py -L "$L" -n "$n" --samples 200 --no-plot)
    ...
    echo "$L,$n,1.0,1.0,200,$zeta_s,$zeta_s_err,$W2_direct,$W2_parseval" >> "$OUTFILE"

    echo "n=$n -> zeta_s=$zeta_s +/- $zeta_s_err   W2=$W2_direct"
done
